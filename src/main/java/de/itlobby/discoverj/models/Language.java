...
public enum Language {
  ...
  ENGLISH(
    Locale.US,
    "languages/disCoverJ_en.properties",
    "/images/flags/us.png"
  ),
  GERMAN(
    Locale.GERMAN,
    "languages/disCoverJ_de.properties",
    "/images/flags/de.png"
  ),
  SPANISH(
    Locale.forLanguageTag("es-ES"),
    "languages/disCoverJ_es.properties",
    "/images/flags/es.png"
  ),
  HEBREW(
    Locale.forLanguageTag("he"),
    "languages/disCoverJ_he.properties",
    "/images/flags/il.png"
  ),
  CHINESE(
    Locale.SIMPLIFIED_CHINESE,
    "languages/disCoverJ_zh.properties",
    "/images/flags/cn.png"
  ),
  HINDI(
    Locale.of("hi", "IN"),
    "languages/disCoverJ_hi.properties",
    "/images/flags/in.png"
  );
