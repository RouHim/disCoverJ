...
public class AudioWrapper implements Comparable<AudioWrapper> {
  ...
  public int compareTo(AudioWrapper other) {
    ...
    int trackNumberComparisonResult = compareTrackNumbers(
      this.trackNumber,
      other.trackNumber
    );
  ...
  private int compareTrackNumbers(
    String thisTrackNumber,
    String otherTrackNumber
  ) {
  ...
  private int compareFileNames(String thisFileName, String otherFileName) {
    return new File(thisFileName)
      .getName()
      .compareTo(new File(otherFileName).getName());
  }
