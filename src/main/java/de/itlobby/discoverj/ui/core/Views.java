...
public enum Views {
  ...
  COVER_DETAIL_VIEW(
    "views/CoverDetailView.fxml",
    "views.coverDetailView",
    CoverDetailViewController.class
  ),
  DROP_FILE_VIEW("views/DropFileView.fxml", "", OpenFileViewController.class),
  MULTI_SELECTION_LAYOUT_VIEW(
    "views/MuliselectionLayoutView.fxml",
    "",
    MultiselectionLayoutViewController.class
  ),
  IMAGE_SELECTION_VIEW(
    "views/ImageSelectionView.fxml",
    "",
