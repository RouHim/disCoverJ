...
public class ImageSelectionViewController implements ViewController {
  ...
  public void initialize() {
    flowPane
      ...
      .bind(baseLayout.widthProperty().subtract(20));
    createNoImage();
  }
  ...
  public VBox buildCoverImageView(BufferedImage image) {
    ...
    ImageView imageView = new ImageView(
      ImageUtil.toFXImage(image, (int) fitWidth, fitHeight)
    );
    ...
    Label resInfo = new Label(
      String.format("(%sx%s)", image.getWidth(), image.getHeight())
    );
  ...
  private void createNoImage() {
    ...
    noImage.setStyle(
      "-fx-fill: red; -fx-font-family: FontAwesome; -fx-font-size: 128px;"
    );
  }
}
