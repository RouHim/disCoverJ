...
public class AwesomeHelper {
    ...
    public static void setIconButton(
        ...
        iconView.setStyle("-fx-font-family: FontAwesome; -fx-font-size: " + iconSize + "em;");
    ...
    public static void createCircleAnimation(
        ...
        TranslateTransition tt1 = new TranslateTransition(duration, btnActionCircle);
        TranslateTransition tt2 = new TranslateTransition(duration, btnActionCircleIcon);
        tt1.setByY(byY);
        tt1.setToY(toY);
        tt2.setByY(byY);
        tt2.setToY(toY);
